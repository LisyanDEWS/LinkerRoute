(() => {
  ...
  function applyM3Theme(theme, paletteId) {
  ...
  // src/client/proxyService.ts
  var scramjetInstance = null;
  var bareMuxConn = null;
  function searchUrl(input, template = "https://duckduckgo.com/?q=%s") {
    if (!input) return "";
  ...
  function isGoogleRedirect(fromUrl, toUrl) {
    try {
      ...
      const isGoogle = (h) => h === "google.com" || h === "www.google.com" || h.endsWith(".google.com") || h === "google.ru" || h === "www.google.ru";
      return isGoogle(from.hostname) && isGoogle(to.hostname);
    } catch (e) {
      return false;
    }
  }
  function cleanScramjetUrl(rawUrl) {
    if (!rawUrl) return "";
    let cleanUrl = rawUrl;
    try {
  ...
  var Palette = createLucideIcon("palette", __iconNode11);
  ...
  var PanelLeft = createLucideIcon("panel-left", __iconNode12);
  ...
  var RotateCw = createLucideIcon("rotate-cw", __iconNode15);
  ...
  var Sidebar = ({
    ...
    return /* @__PURE__ */ import_react4.default.createElement(
      "aside",
      {
        className: `flex flex-col border flex-shrink-0 transition-all duration-300 select-none z-30 overflow-hidden rounded-2xl md:rounded-3xl shadow-sm ${!isOpen ? "w-0 border-0 opacity-0 pointer-events-none p-0" : compact ? "w-56 opacity-100" : "w-64 opacity-100"}`,
        style: {
      ...
      /* @__PURE__ */ import_react4.default.createElement("div", { className: "p-3.5 md:p-4 flex items-center justify-between min-w-[210px]" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ import_react4.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react4.default.createElement(Globe, { className: "w-4 h-4 opacity-80" })
      ), /* @__PURE__ */ import_react4.default.createElement("span", { className: "font-black text-base md:text-lg tracking-tight", style: { color: "var(--on-surface)" } }, "LinkerRoute"))),
      /* @__PURE__ */ import_react4.default.createElement("div", { className: "flex-1 overflow-y-auto px-3 py-1 flex flex-col gap-1.5 custom-scrollbar" }, tabs.map((tab) => {
        ...
        return /* @__PURE__ */ import_react4.default.createElement(
          "div",
          {
            ...
            className: `group relative flex items-center gap-2.5 cursor-pointer transition-all duration-200 ${compact ? "py-1.5 px-3 rounded-full text-xs" : "py-2.5 px-3.5 rounded-full text-sm"} ${isActive ? "font-semibold shadow-sm border" : "hover:bg-opacity-80"}`,
            style: {
          ...
          isActive && /* @__PURE__ */ import_react4.default.createElement(
            "div",
            {
          ...
          tab.favicon ? /* @__PURE__ */ import_react4.default.createElement(
            "img",
            {
              src: tab.favicon,
              alt: "",
          ...
          ) : tab.isLoaded ? /* @__PURE__ */ import_react4.default.createElement(
            "div",
            {
            ...
            letter
          ) : /* @__PURE__ */ import_react4.default.createElement(Globe, { className: "w-4 h-4 opacity-60 flex-shrink-0 ml-1" }),
          /* @__PURE__ */ import_react4.default.createElement("span", { className: "flex-1 truncate pr-1" }, tab.title || "New Tab"),
          /* @__PURE__ */ import_react4.default.createElement(
            ...
            /* @__PURE__ */ import_react4.default.createElement(X, { className: "w-3.5 h-3.5" })
          )
        );
      })),
      /* @__PURE__ */ import_react4.default.createElement("div", { className: "p-3" }, /* @__PURE__ */ import_react4.default.createElement(
        "button",
        {
          onClick: onNewTab,
        ...
        /* @__PURE__ */ import_react4.default.createElement(Plus, { className: "w-4 h-4" }),
        /* @__PURE__ */ import_react4.default.createElement("span", null, "New Tab")
      )),
      /* @__PURE__ */ import_react4.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react4.default.createElement(
          ...
          /* @__PURE__ */ import_react4.default.createElement(Settings, { className: "w-4 h-4" }),
          /* @__PURE__ */ import_react4.default.createElement("span", null, "Settings")
        )
      )
    );
  };
  ...
  // src/client/components/SearchEnginePicker.tsx
  var import_react5 = __toESM(require_react(), 1);
  var SearchEnginePicker = ({
    selectedId,
    onSelect,
    compact = false
  }) => {
    ...
    return /* @__PURE__ */ import_react5.default.createElement("div", { className: "relative flex-shrink-0", ref: containerRef }, /* @__PURE__ */ import_react5.default.createElement(
      "button",
      {
        type: "button",
        onClick: () => setIsOpen(!isOpen),
        className: `flex items-center gap-1.5 rounded-full border transition-all duration-150 active:scale-95 ${compact ? "px-2 py-0.5 text-[11px]" : "px-2.5 py-1 text-xs"} font-bold`,
        style: {
          backgroundColor: "var(--container-high)",
          borderColor: "var(--outline-var)",
          color: "var(--on-surface)"
      ...
      /* @__PURE__ */ import_react5.default.createElement(Zap, { className: `${compact ? "w-3 h-3" : "w-3.5 h-3.5"} opacity-70` }),
      /* @__PURE__ */ import_react5.default.createElement("span", { className: "truncate max-w-[90px] sm:max-w-[120px]" }, currentEngine.name),
      /* @__PURE__ */ import_react5.default.createElement(ChevronDown, { className: `w-3 h-3 transition-transform duration-200 ${isOpen ? "rotate-180" : ""} opacity-70` })
    ), isOpen && /* @__PURE__ */ import_react5.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react5.default.createElement("div", { className: "px-3 py-1.5 text-[10px] font-extrabold tracking-wider uppercase opacity-60 border-b mb-1", style: { borderColor: "var(--outline-var)", color: "var(--on-surface-var)" } }, "Search Engines"),
      /* @__PURE__ */ import_react5.default.createElement("div", { className: "space-y-0.5" }, SEARCH_ENGINES.map((engine) => {
        ...
        return /* @__PURE__ */ import_react5.default.createElement(
          ...
          /* @__PURE__ */ import_react5.default.createElement("div", { className: "min-w-0 flex-1 pr-2" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "text-xs font-bold truncate group-hover:opacity-100" }, engine.name), /* @__PURE__ */ import_react5.default.createElement("div", { className: "text-[10px] opacity-60 truncate" }, engine.description)),
          isSelected && /* @__PURE__ */ import_react5.default.createElement(
            ...
            /* @__PURE__ */ import_react5.default.createElement(Check, { className: "w-2.5 h-2.5" })
          )
        );
      }))
    ));
  ...
  var TopBar = ({
    ...
    return /* @__PURE__ */ import_react6.default.createElement(
      ...
      /* @__PURE__ */ import_react6.default.createElement("div", { className: "flex items-center gap-1.5 flex-shrink-0" }, /* @__PURE__ */ import_react6.default.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ import_react6.default.createElement(PanelLeft, { className: "w-4 h-4" })
      ), /* @__PURE__ */ import_react6.default.createElement("div", { className: "h-4 w-[1px] mx-1 opacity-40", style: { backgroundColor: "var(--outline-var)" } }), /* @__PURE__ */ import_react6.default.createElement(
        "button",
        {
          onClick: onBack,
          disabled: !canGoBack,
        ...
        /* @__PURE__ */ import_react6.default.createElement(ArrowLeft, { className: "w-4 h-4" })
        ...
        /* @__PURE__ */ import_react6.default.createElement(ArrowRight, { className: "w-4 h-4" })
      ), /* @__PURE__ */ import_react6.default.createElement(
        "button",
        {
          onClick: onReload,
        ...
        /* @__PURE__ */ import_react6.default.createElement(RotateCw, { className: `w-4 h-4 ${activeTab?.isLoading ? "animate-spin" : ""}` })
      ), /* @__PURE__ */ import_react6.default.createElement(
        "button",
        {
          onClick: onHome,
        ...
        /* @__PURE__ */ import_react6.default.createElement(House, { className: "w-4 h-4" })
      )),
      /* @__PURE__ */ import_react6.default.createElement("form", { onSubmit: handleSubmit, className: "flex-1 max-w-4xl min-w-0 mx-auto px-1" }, /* @__PURE__ */ import_react6.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react6.default.createElement(Lock, { className: "w-3.5 h-3.5 flex-shrink-0 opacity-60 ml-1", style: { color: "var(--on-surface-var)" } }),
        /* @__PURE__ */ import_react6.default.createElement(
          SearchEnginePicker,
          {
        ...
        inputValue && /* @__PURE__ */ import_react6.default.createElement(
          "button",
          {
            type: "button",
          ...
          /* @__PURE__ */ import_react6.default.createElement(X, { className: "w-3.5 h-3.5" })
        ),
        /* @__PURE__ */ import_react6.default.createElement(
          "button",
          {
          ...
          /* @__PURE__ */ import_react6.default.createElement(Search, { className: "w-3 h-3" }),
          /* @__PURE__ */ import_react6.default.createElement("span", null, "Go")
        )
      )),
      /* @__PURE__ */ import_react6.default.createElement("div", { className: "flex items-center gap-1.5 flex-shrink-0" }, /* @__PURE__ */ import_react6.default.createElement(
        "button",
        ...
        /* @__PURE__ */ import_react6.default.createElement(Settings, { className: "w-4 h-4" })
      ))
    );
  };

  // src/client/components/TabViewport.tsx
  ...
  var Dashboard = ({
    ...
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "h-full w-full overflow-y-auto flex flex-col items-center justify-center p-6 md:p-12 relative select-none" }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "relative z-10 flex flex-col items-center max-w-3xl w-full text-center" }, /* @__PURE__ */ import_react7.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react7.default.createElement(Globe, { className: "w-10 h-10 opacity-90" })
    ), /* @__PURE__ */ import_react7.default.createElement("h1", { className: "text-3xl md:text-4xl font-black tracking-tight mb-8", style: { color: "var(--on-surface)" } }, "LinkerRoute"), /* @__PURE__ */ import_react7.default.createElement("div", { className: "w-full max-w-2xl mb-10" }, /* @__PURE__ */ import_react7.default.createElement("form", { onSubmit: handleSubmit, className: "w-full" }, /* @__PURE__ */ import_react7.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react7.default.createElement(
        ...
        /* @__PURE__ */ import_react7.default.createElement(ArrowRight, { className: "w-5 h-5" })
      )
    ))), /* @__PURE__ */ import_react7.default.createElement("div", { className: "w-full max-w-2xl" }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "flex items-center justify-between mb-4 px-2" }, /* @__PURE__ */ import_react7.default.createElement("span", { className: "text-xs font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Quick Launch"), /* @__PURE__ */ import_react7.default.createElement(
      "button",
      {
        onClick: onOpenSettings,
      ...
      /* @__PURE__ */ import_react7.default.createElement(Plus, { className: "w-3.5 h-3.5 opacity-80" }),
      /* @__PURE__ */ import_react7.default.createElement("span", null, "Add Link")
    )), /* @__PURE__ */ import_react7.default.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4 w-full" }, displayedLinks.map((link, idx) => /* @__PURE__ */ import_react7.default.createElement(
      "button",
      {
        key: idx,
      ...
      /* @__PURE__ */ import_react7.default.createElement("span", { className: "text-xs md:text-sm font-bold truncate max-w-[110px]", style: { color: "var(--on-surface)" } }, link.name)
    ))))));
  };
  ...
  var TabViewport = ({
    ...
    return /* @__PURE__ */ import_react8.default.createElement(
      ...
      !tab.isLoaded && /* @__PURE__ */ import_react8.default.createElement(
        Dashboard,
        {
          quickLinks,
          searchEngine,
      ...
      tab.isLoading && /* @__PURE__ */ import_react8.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react8.default.createElement("span", { className: "text-xs font-bold px-3 py-1 rounded-full border shadow-sm", style: { backgroundColor: "var(--surface)", borderColor: "var(--outline-var)", color: "var(--on-surface)" } }, "Routing through tunnel...")
      )
    );
  };
  ...
  var SettingsModal = ({
    ...
    const [nodeStatus, setNodeStatus] = (0, import_react9.useState)(null);
    const [loadingNode, setLoadingNode] = (0, import_react9.useState)(false);
    const [clearingData, setClearingData] = (0, import_react9.useState)(false);
    const [clearStatus, setClearStatus] = (0, import_react9.useState)(null);
    const [editingLinks, setEditingLinks] = (0, import_react9.useState)(settings.quickLinks);
    ...
    return /* @__PURE__ */ import_react9.default.createElement("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fadeIn select-none" }, /* @__PURE__ */ import_react9.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react9.default.createElement(
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("h2", { className: "text-xl md:text-2xl font-black tracking-tight", style: { color: "var(--on-surface)" } }, "Settings & Preferences"), /* @__PURE__ */ import_react9.default.createElement("p", { className: "text-xs font-medium opacity-70", style: { color: "var(--on-surface-var)" } }, "Material 3 Expressive Customization & Search Options")),
        /* @__PURE__ */ import_react9.default.createElement(
          "button",
          {
            onClick: onClose,
          ...
          /* @__PURE__ */ import_react9.default.createElement(X, { className: "w-5 h-5" })
        )
      ),
      /* @__PURE__ */ import_react9.default.createElement("div", { className: "px-6 pt-4 flex gap-2 border-b pb-3", style: { borderColor: "var(--outline-var)" } }, [
        ...
        return /* @__PURE__ */ import_react9.default.createElement(
          ...
          /* @__PURE__ */ import_react9.default.createElement(Icon2, { className: "w-3.5 h-3.5" }),
          /* @__PURE__ */ import_react9.default.createElement("span", null, tab.label)
        );
      })),
      /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex-1 overflow-y-auto p-6 md:p-7 space-y-6 custom-scrollbar" }, activeTab === "general" && /* @__PURE__ */ import_react9.default.createElement("div", { className: "space-y-5" }, /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center gap-2 mb-1" }, /* @__PURE__ */ import_react9.default.createElement(Search, { className: "w-4 h-4 opacity-70", style: { color: "var(--on-surface)" } }), /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-sm font-bold", style: { color: "var(--on-surface)" } }, "Search Engine")),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs mb-3.5 opacity-70", style: { color: "var(--on-surface-var)" } }, "Select your search provider for direct search queries"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2" }, SEARCH_ENGINES.map((eng) => {
          ...
          return /* @__PURE__ */ import_react9.default.createElement(
            ...
            /* @__PURE__ */ import_react9.default.createElement(
              ...
              isSelected && /* @__PURE__ */ import_react9.default.createElement("div", { className: "w-1.5 h-1.5 rounded-full bg-black dark:bg-white" })
            ),
            /* @__PURE__ */ import_react9.default.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs font-bold truncate" }, eng.name), /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[10px] opacity-70 truncate" }, eng.description))
          );
        }))
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-sm font-bold", style: { color: "var(--on-surface)" } }, "Color Scheme"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs opacity-70", style: { color: "var(--on-surface-var)" } }, "Switch between Dark and Light Material 3 modes")), /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center gap-1.5 p-1 rounded-full border", style: { backgroundColor: "var(--surface)", borderColor: "var(--outline)" } }, /* @__PURE__ */ import_react9.default.createElement(
          "button",
          {
          ...
          /* @__PURE__ */ import_react9.default.createElement(Moon, { className: "w-3.5 h-3.5" }),
          " Dark"
        ), /* @__PURE__ */ import_react9.default.createElement(
          "button",
          {
          ...
          /* @__PURE__ */ import_react9.default.createElement(Sun, { className: "w-3.5 h-3.5" }),
          " Light"
        )))
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-sm font-bold mb-1", style: { color: "var(--on-surface)" } }, "Monochrome Style Presets"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs mb-4 opacity-70", style: { color: "var(--on-surface-var)" } }, "Choose a sleek monochrome contrast level"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "grid grid-cols-2 gap-2.5" }, PALETTES.map((p) => {
          ...
          return /* @__PURE__ */ import_react9.default.createElement(
            ...
            /* @__PURE__ */ import_react9.default.createElement(
              ...
              isSelected && /* @__PURE__ */ import_react9.default.createElement(Check, { className: "w-3 h-3 text-black dark:text-white" })
            ),
            /* @__PURE__ */ import_react9.default.createElement("span", { className: "text-xs font-bold truncate", style: { color: "var(--on-surface)" } }, p.name)
          );
        }))
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-sm font-bold", style: { color: "var(--on-surface)" } }, "Compact Tabs Mode"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs opacity-70", style: { color: "var(--on-surface-var)" } }, "Slim down tab pills in the left sidebar")),
        /* @__PURE__ */ import_react9.default.createElement(
          "button",
          {
          ...
          /* @__PURE__ */ import_react9.default.createElement(
            "div",
            {
              className: `w-5 h-5 rounded-full bg-white transition-transform duration-200 ${settings.compactTabs ? "translate-x-5" : "translate-x-0"}`
            }
          )
        )
      ), /* @__PURE__ */ import_react9.default.createElement(
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center justify-between mb-2" }, /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-sm font-bold", style: { color: "var(--on-surface)" } }, "Clear Browsing Data"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs opacity-70", style: { color: "var(--on-surface-var)" } }, "Wipes all proxied cookies, IndexedDB, worker caches, and sessions"))),
        clearStatus && /* @__PURE__ */ import_react9.default.createElement("div", { className: "my-2 p-2.5 rounded-full bg-zinc-800 border border-zinc-700 text-zinc-300 text-xs font-semibold text-center" }, clearStatus),
        /* @__PURE__ */ import_react9.default.createElement(
          "button",
          {
          ...
          /* @__PURE__ */ import_react9.default.createElement(Trash2, { className: "w-4 h-4" }),
          /* @__PURE__ */ import_react9.default.createElement("span", null, clearingData ? "Clearing Storage..." : "Flush Cookies & Browsing Data")
        )
      ), /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex justify-center gap-4 text-xs font-semibold pt-2", style: { color: "var(--on-surface-var)" } }, /* @__PURE__ */ import_react9.default.createElement(
        "a",
        {
          href: "/credits.html",
          target: "_blank",
        ...
        /* @__PURE__ */ import_react9.default.createElement(ExternalLink, { className: "w-3.5 h-3.5" }),
        " View Open Source Licenses"
      ))), activeTab === "links" && /* @__PURE__ */ import_react9.default.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ import_react9.default.createElement("span", { className: "text-xs font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Dashboard Speed Dial Links"), /* @__PURE__ */ import_react9.default.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ import_react9.default.createElement(Plus, { className: "w-3.5 h-3.5" }),
        " Add Link"
      )), /* @__PURE__ */ import_react9.default.createElement("div", { className: "space-y-2.5" }, editingLinks.map((link, idx) => /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
          key: idx,
      ...
      )))), activeTab === "node" && /* @__PURE__ */ import_react9.default.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center justify-between mb-2" }, /* @__PURE__ */ import_react9.default.createElement("span", { className: "text-xs font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Active Fastify & Wisp Node Status"), /* @__PURE__ */ import_react9.default.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ import_react9.default.createElement(RefreshCw, { className: `w-3.5 h-3.5 ${loadingNode ? "animate-spin" : ""}` }),
        " Refresh"
      )), nodeStatus ? /* @__PURE__ */ import_react9.default.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
          className: "p-4 rounded-[28px] border",
          style: { backgroundColor: "var(--surface-dim)", borderColor: "var(--outline-var)" }
        },
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[11px] font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Node Status"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-lg font-black flex items-center gap-1.5 mt-1", style: { color: "var(--on-surface)" } }, /* @__PURE__ */ import_react9.default.createElement("span", { className: "w-2.5 h-2.5 rounded-full bg-zinc-200 animate-pulse" }), nodeStatus.status.toUpperCase())
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
          className: "p-4 rounded-[28px] border",
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[11px] font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Server Uptime"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-lg font-black mt-1", style: { color: "var(--on-surface)" } }, nodeStatus.uptime, " (", Math.round(nodeStatus.uptime_seconds), "s)")
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
          className: "p-4 rounded-[28px] border",
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[11px] font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Active Connections"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-lg font-black mt-1", style: { color: "var(--on-surface)" } }, nodeStatus.active_connections)
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
          className: "p-4 rounded-[28px] border",
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[11px] font-bold uppercase tracking-wider opacity-70", style: { color: "var(--on-surface-var)" } }, "Heap Memory"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-lg font-black mt-1", style: { color: "var(--on-surface)" } }, nodeStatus.memory_mb, " MB (", nodeStatus.memory_usage, "%)")
      ), /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[11px] font-bold uppercase tracking-wider mb-2 opacity-70", style: { color: "var(--on-surface-var)" } }, "System Environment"),
        /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-xs font-mono space-y-1 opacity-80", style: { color: "var(--on-surface)" } }, /* @__PURE__ */ import_react9.default.createElement("div", null, "Node.js Version: ", /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-bold" }, nodeStatus.node_version)), /* @__PURE__ */ import_react9.default.createElement("div", null, "App Version: ", /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-bold" }, nodeStatus.version)), /* @__PURE__ */ import_react9.default.createElement("div", null, "Platform / Arch: ", /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-bold" }, nodeStatus.platform, " (", nodeStatus.arch, ")")), /* @__PURE__ */ import_react9.default.createElement("div", null, "Process PID: ", /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-bold" }, nodeStatus.pid)))
      )) : /* @__PURE__ */ import_react9.default.createElement("div", { className: "p-8 text-center rounded-[28px] border", style: { backgroundColor: "var(--surface-dim)", borderColor: "var(--outline-var)" } }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-sm font-semibold opacity-70", style: { color: "var(--on-surface-var)" } }, "Connecting to local Node.js diagnostics endpoint...")))),
      /* @__PURE__ */ import_react9.default.createElement(
        "div",
        {
  ...
  // src/client/App.tsx
  var SETTINGS_KEY = "linkerru_proxy_settings";
  ...
  var App = () => {
    ...
    const [isSidebarOpen, setIsSidebarOpen] = (0, import_react10.useState)(true);
    const [isSettingsOpen, setIsSettingsOpen] = (0, import_react10.useState)(false);
    const [nodeOnline, setNodeOnline] = (0, import_react10.useState)(false);
    ...
    const [activeTabId, setActiveTabId] = (0, import_react10.useState)(tabs[0].id);
    const tabsRef = (0, import_react10.useRef)(tabs);
    tabsRef.current = tabs;
    const activeTabIdRef = (0, import_react10.useRef)(activeTabId);
    activeTabIdRef.current = activeTabId;
    const settingsRef = (0, import_react10.useRef)(settings);
    ...
    (0, import_react10.useEffect)(() => {
      ...
      checkNode();
      const interval = setInterval(checkNode, 2e4);
      ...
      const handleMessage = (event) => {
        ...
        if (data && data.type === "LINKERR_SYNC") {
          ...
          const matchingTab = currentTabs.find((t) => {
            const ifr = document.getElementById("ifr-" + t.id);
          ...
          if (matchingTab) {
            ...
            setTabs(
              (prev) => prev.map((t) => {
                ...
                } else if (t.expectingRedirect && t.lastUrl !== cleanUrl && isGoogleRedirect(t.lastUrl, cleanUrl)) {
    ...
    const handleNewTab = (0, import_react10.useCallback)(() => {
    ...
    const handleCloseTab = (0, import_react10.useCallback)(
      (tabId, e) => {
        e.stopPropagation();
        setTabs((prev) => {
    ...
    const handleSelectTab = (0, import_react10.useCallback)((tabId) => {
    ...
    const loadUrlInTab = (0, import_react10.useCallback)(async (tabId, inputUrl) => {
      if (!inputUrl) return;
      ...
      setTimeout(() => {
        setTabs(
          (prev) => prev.map((t) => t.id === tabId && t.isLoading ? { ...t, isLoading: false } : t)
        );
      }, 8e3);
    }, []);
    ...
    const handleReload = (0, import_react10.useCallback)(() => {
      const current = tabsRef.current.find((t) => t.id === activeTabIdRef.current);
      ...
      if (currentUrl) {
        ...
        setTabs(
          (prev) => prev.map((t) => t.id === current.id ? { ...t, isLoading: true } : t)
        );
      }
    }, []);
    const handleHome = (0, import_react10.useCallback)(() => {
      const current = tabsRef.current.find((t) => t.id === activeTabIdRef.current);
      if (!current) return;
      setTabs(
        (prev) => prev.map(
    ...
    return /* @__PURE__ */ import_react10.default.createElement(
      ...
      /* @__PURE__ */ import_react10.default.createElement("main", { className: "flex-1 flex flex-col h-full overflow-hidden relative transition-all duration-300 min-w-0 gap-2 md:gap-3" }, /* @__PURE__ */ import_react10.default.createElement(
        TopBar,
        {
          activeTab,
        ...
        tabs.map((tab) => /* @__PURE__ */ import_react10.default.createElement(
          TabViewport,
          {
            ...
            onFrameCreated: (tabId, frameObj) => {
              setTabs(
                (prev) => prev.map((t) => t.id === tabId ? { ...t, frameObj } : t)
              );
            },
            onLoadFinished: (tabId) => {
              setTabs(
                (prev) => prev.map((t) => t.id === tabId ? { ...t, isLoading: false } : t)
              );
            }
          }
        ))
